// Shader with thresholding (cartoon look)

Shader "Unlit/Shader 010"
{
    Properties {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (VertexOutput o) : SV_Target
            {
                ...
                diffuseFallout = step(0.1, diffuseFallout); //apply falloff to diffuse
                ...
                specularLight = step(0.1, specularLight); //apply fallout to specular
